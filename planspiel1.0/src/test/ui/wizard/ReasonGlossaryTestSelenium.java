 ...
 *
 */
public class ReasonGlossaryTestSelenium {
	private Logger log;
	private String baseUrl = "http://bpmnserver:8080";
	private StringBuffer verificationErrors = new StringBuffer();

	private String testName = "ReasonGlossaryTest";
	...
	public void test() throws Exception {
		try{
		driver.get(baseUrl + "/planspielBPMN/crudtest/reasonglossary");
		WebElement element = 
		driver.findElement(By.name("create:reasonname"));
		element.sendKeys(testName);
		driver.findElement(By.id("create:createNewReasonGlossary")).click();
		...
		element = driver.findElement(By.id("update:reasonGlossaryID"));
		...
		driver.findElement(By.id("update:updateReasonGlossary")).click();
		new WebDriverWait(driver, 4).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(XPATH_ORDER_NAME)));
		Thread.sleep(500);
		...
		element = driver.findElement(By.id("delete:reasonGlossaryID"));	
		...
		element.sendKeys(lastIdText);
		Thread.sleep(1000);
		driver.findElement(By.id("delete:deleteReasonGlossary")).click();
		Thread.sleep(1000);
